...
peripheral_reset_and_enable_control! {
    ...
    AHB4, "AMBA High-performance Bus (AHB4) peripherals" => [
        Octospi1  [kernel clk: Octospi1 ccipr4 "OCTOSPI1"],
        Fmc,

        Sdmmc1 [kernel clk: Sdmmc1 ccipr4 "SDMMC1"]
    ];
    #[cfg(feature = "sdmmc2")]
    AHB4, "" => [
        Sdmmc2 [kernel clk: Sdmmc2 ccipr4 "SDMMC2"]
    ];
    #[cfg(feature = "otfdec")]
    AHB4, "" => [
        Otfdec1
    ...
    #[cfg(feature = "rm0481")]
    APB1L, "" => [
        Uart8 [kernel clk: Uart8(Variant) ccipr1 "UART8"],
        Uart7 [kernel clk: Uart7(Variant) ccipr1 "UART7"],
        Cec [kernel clk: Cec(Variant) ccipr5 "CEC"],
        Usart11 [kernel clk: Usart11(Variant) ccipr2 "USART11"],
        Usart10 [kernel clk: Usart10(Variant) ccipr1 "USART10"],
        Usart6 [kernel clk: Usart6(Variant) ccipr1 "USART6"],
        Uart5 [kernel clk: Uart5(Variant) ccipr1 "USART5"],
        Uart4 [kernel clk: Uart4(Variant) ccipr1 "USART4"],
    ...
    APB1H, "" => [
        Ucpd1,
        Uart12 [kernel clk: Uart12(Variant) ccipr2 "USART12"],
        Uart9 [kernel clk: Uart9(Variant) ccipr1 "UART9"]
    ];
    ...
    #[cfg(feature = "rm0481")]
    APB2, "" => [
        Sai2 [kernel clk: Sai2(Variant) ccipr5 "SAI2"],
        Sai1 [kernel clk: Sai1(Variant) ccipr5 "SAI1"],
        Spi6 [kernel clk: Spi6(Variant) ccipr3 "SPI6"],
        Spi4 [kernel clk: Spi4(Variant) ccipr3 "SPI4"],
    ...
    APB3, "" => [
        Vref,
        LpTim6 [kernel clk: LpTim6(Variant) ccipr2 "LPTIM6"],
        LpTim5 [kernel clk: LpTim5(Variant) ccipr2 "LPTIM5"],
        LpTim4 [kernel clk: LpTim4(Variant) ccipr2 "LPTIM4"],
        LpTim3 [kernel clk: LpTim3(Variant) ccipr2 "LPTIM3"],
        I2c4 [kernel clk: I2c4 ccipr4 "I2C4"],
        I2c3 [kernel clk: I2c3 ccipr4 "I2C3"],
        Spi5 [kernel clk: Spi5(Variant) ccipr3 "SPI5"]
    ];
