...
mod h567x {
    ...
    gpio!(GPIOC, gpioc, Gpioc, PC, 'C', PCn, [
        ...
        PC1: (pc1, 1, [0, 2, 5, 6, 7, 8, 9, 10, 11, 15], crate::gpio::Debugger),
        ...
        PC7: (pc7, 7, [0, 2, 3, 6, 7, 8, 9, 10, 11, 12, 13, 15], crate::gpio::Debugger),
        PC8: (pc8, 8, [0, 2, 3, 7, 8, 9, 10, 11, 12, 13, 15], crate::gpio::Debugger),
        PC9: (pc9, 9, [0, 2, 3, 4, 5, 8, 9, 11, 12, 13, 15]),
        PC10: (pc10, 10, [2, 6, 7, 8, 9, 11, 12, 13, 15]),
        PC11: (pc11, 11, [2, 6, 7, 8, 9, 12, 13, 15]),
        PC12: (pc12, 12, [0, 2, 5, 6, 7, 8, 12, 13, 15], crate::gpio::Debugger),
        PC13: (pc13, 13, [15]),
        PC14: (pc14, 14, [15]),
        PC15: (pc15, 15, [15]),
    ]);
    ...
    gpio!(GPIOD, gpiod, Gpiod, PD, 'D', PDn, [
        ...
        PD1: (pd1, 1, [8, 9, 12, 15]),
        PD2: (pd2, 2, [0, 2, 4, 8, 12, 13, 14, 15], crate::gpio::Debugger),
    ...
    gpio!(GPIOE, gpioe, Gpioe, PE, 'E', PEn, [
        ...
        PE2: (pe2, 2, [0, 1, 2, 5, 6, 7, 8, 9, 11, 12, 13, 15], crate::gpio::Debugger),
        PE3: (pe3, 3, [0, 4, 6, 7, 12, 15], crate::gpio::Debugger),
        PE4: (pe4, 4, [0, 2, 4, 5, 6, 12, 13, 15], crate::gpio::Debugger),
        PE5: (pe5, 5, [0, 2, 4, 5, 6, 12, 13, 15], crate::gpio::Debugger),
        PE6: (pe6, 6, [0, 1, 2, 4, 5, 6, 10, 12, 13, 15], crate::gpio::Debugger),
    ...
    gpio!(GPIOG, gpiog, Gpiog, PG, 'G', PGn, [
        ...
        PG13: (pg13, 13, [0, 1, 5, 6, 7, 10, 11, 12, 13, 15], crate::gpio::Debugger),
        PG14: (pg14, 14, [0, 1, 4, 5, 6, 7, 10, 11, 12, 13, 15], crate::gpio::Debugger),
